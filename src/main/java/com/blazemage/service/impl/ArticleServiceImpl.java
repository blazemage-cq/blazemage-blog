...
import com.blazemage.vo.*;
import com.blazemage.common.*;
import com.blazemage.entity.*;
import com.blazemage.enums.SearchModelEnum;
import com.blazemage.enums.YesOrNoEnum;
import com.blazemage.exception.BusinessException;
import com.blazemage.mapper.*;
import com.blazemage.service.ArticleService;
import com.blazemage.service.SystemConfigService;
import com.blazemage.strategy.context.SearchStrategyContext;
import com.blazemage.util.*;
import com.blazemage.dto.ArticleDTO;
...
import static com.blazemage.common.Constants.*;
import static com.blazemage.common.RedisConstants.*;
import static com.blazemage.common.ResultCode.*;
import static com.blazemage.enums.PublishEnum.PUBLISH;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, BlogArticle> implements ArticleService {
    ...
    public ResponseResult articleSeo(List<Long> ids) {
        ...
        ids.forEach(item -> {
            String url = "http://www.blazemaget.com/article/" + item;
